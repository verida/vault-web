...
export type IncomingDataItemPageProps = {
  open: boolean
  onClose: () => void
  // TODO: Add inbox entry
}

export function IncomingDataItemPage(props: IncomingDataItemPageProps) {
...
IncomingDataItemPage.displayName = "IncomingDataItemPage"
